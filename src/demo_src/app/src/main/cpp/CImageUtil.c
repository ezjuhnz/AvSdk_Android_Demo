...
Java_com_example_previewdemo_sdk_JniImageUtil_rgbToI420(JNIEnv *env, jclass clazz, jbyteArray rgb,
...
JNIEXPORT jint JNICALL
Java_com_example_previewdemo_sdk_JniImageUtil_rgbToNV21(JNIEnv *env, jclass clazz, jbyteArray rgb,
                                           jint line_stride, jint width, jint height,
                                           jbyteArray i420_buf) {
...
Java_com_example_previewdemo_sdk_JniImageUtil_yuvAddWaterMark(JNIEnv *env, jclass clazz, jint yuv_type,
...
JNIEXPORT void JNICALL
Java_com_example_previewdemo_sdk_JniImageUtil_Nv21ToNv12(JNIEnv *env, jclass clazz, jbyteArray jNv21Data,
...
JNIEXPORT jint JNICALL
Java_com_example_previewdemo_sdk_JniImageUtil_I420ToNV21(JNIEnv *env, jclass clazz, jbyteArray i420_data,
